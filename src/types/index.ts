...
export type ViewId = 'dashboard' | 'calendar' | 'todos' | 'chores' | 'school' | 'shopping' | 'recipes' | 'notes' | 'journal' | 'messages' | 'media' | 'comics' | 'themestudio' | 'play' | 'settings' | 'coinmath';
...
export type ThemeId = 'dark' | 'light' | 'neon' | 'spyfamily';
